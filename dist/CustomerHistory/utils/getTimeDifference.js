...
function getTimeDifference(createdAt, closeAt) {
  ...
  return `${days !== 0 ? days + 'd : ' : ''} ${hours !== 0 ? hours + 'h : ' : ''} ${minutes > 10 ? minutes + 'm ' : '0' + minutes + 'm '} ${seconds < 10 && seconds ? ': 0' + seconds + 's' : ': ' + seconds + 's'}`;
}